...
export function applySolarLivery(group: THREE.Group, title = 'Kairo Solar'): void {
  ...
  c.fillStyle='#eff1e7';c.font='600 59px Arial';c.textAlign='center';c.fillText(title.toUpperCase(),583,69);
  ...
  nc.fillStyle='#bfdc9c';nc.font='bold 28px Arial';nc.fillText(title.split(' ')[0].toUpperCase(),128,265);nc.fillText('SOLAR',128,302);
